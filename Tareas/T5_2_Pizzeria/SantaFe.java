...
public class SantaFe extends Sucursal {
	...
	public SantaFe(Ingredientes[] ingredientes, Chef chef, AyudanteChef ayudanteChef, Cajero cajero, Repartidor repartidor) {
	...
	public void recibirOrden(TiposDePizza pizza) {
        ...
        public static SantaFe getInstance(Ingredientes[] ingredientes, Chef chef, AyudanteChef ayudanteChef, Cajero cajero, Repartidor repartidor) {
        if(instance == null) {
